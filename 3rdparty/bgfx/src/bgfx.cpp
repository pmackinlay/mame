...
#undef BGFX_RENDERER_CONTEXT
	...
	static RendererCreator s_rendererCreator[] =
	{
		...
		{ nvn::rendererCreate,    nvn::rendererDestroy,    BGFX_RENDERER_NVN_NAME,        !!bool(BGFX_CONFIG_RENDERER_NVN     )   }, // NVN
		{ gl::rendererCreate,     gl::rendererDestroy,     BGFX_RENDERER_OPENGL_NAME,     !!bool(BGFX_CONFIG_RENDERER_OPENGLES)   }, // OpenGLES
		{ gl::rendererCreate,     gl::rendererDestroy,     BGFX_RENDERER_OPENGL_NAME,     !!bool(BGFX_CONFIG_RENDERER_OPENGL  )   }, // OpenGL
		{ vk::rendererCreate,     vk::rendererDestroy,     BGFX_RENDERER_VULKAN_NAME,     !!bool(BGFX_CONFIG_RENDERER_VULKAN  )   }, // Vulkan
		{ webgpu::rendererCreate, webgpu::rendererDestroy, BGFX_RENDERER_WEBGPU_NAME,     !!bool(BGFX_CONFIG_RENDERER_WEBGPU  )   }, // WebGPU
	};

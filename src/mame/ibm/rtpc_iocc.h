...
public:
	...
	virtual bool mem_load(u32 address, u8 &data, u8 mem_mask, rsc_mode const mode, bool sp) override { return mem_load<u8>(address, data, mode); }
	virtual bool mem_load(u32 address, u16 &data, u16 mem_mask, rsc_mode const mode, bool sp) override { return mem_load<u16>(address, data, mode); }
	virtual bool mem_load(u32 address, u32 &data, u32 mem_mask, rsc_mode const mode, bool sp) override { return mem_load<u32>(address, data, mode); }
	virtual bool mem_store(u32 address, u8 data, u8 mem_mask, rsc_mode const mode, bool sp) override { return mem_store<u8>(address, data, mode); }
	virtual bool mem_store(u32 address, u16 data, u16 mem_mask, rsc_mode const mode, bool sp) override { return mem_store<u16>(address, data, mode); }
	virtual bool mem_store(u32 address, u32 data, u32 mem_mask, rsc_mode const mode, bool sp) override { return mem_store<u32>(address, data, mode); }
	virtual bool mem_modify(u32 address, std::function<u8(u8)> f, u8 mem_mask, rsc_mode const mode) override { return mem_modify<u8>(address, f, mode); }
	virtual bool mem_modify(u32 address, std::function<u16(u16)> f, u16 mem_mask, rsc_mode const mode) override { return mem_modify<u16>(address, f, mode); }
	virtual bool mem_modify(u32 address, std::function<u32(u32)> f, u32 mem_mask, rsc_mode const mode) override { return mem_modify<u32>(address, f, mode); }

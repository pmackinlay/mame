...
protected:
	...
	void colour_palette_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff);
	u32 halfsync_r() { return m_halfsync; }
	void halfsync_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_halfsync = data; }
	u32 backporch_r() { return m_backporch; }
	void backporch_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_backporch = data; }
	u32 display_r() { return m_display; }
	void display_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_display = data; }
	u32 shortdisplay_r() { return m_shortdisplay; }
	void shortdisplay_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_shortdisplay = data; }
	u32 broadpulse_r() { return m_broadpulse; }
	void broadpulse_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_broadpulse = data; }
	u32 vsync_r() { return m_vsync; }
	void vsync_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_vsync = data; }
	u32 vblank_r() { return m_vblank; }
	void vblank_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_vblank = data; }
	u32 vdisplay_r() { return m_vdisplay; }
	void vdisplay_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_vdisplay = data; }
	u32 linetime_r() { return m_linetime; }
	void linetime_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_linetime = data; }
	//u32 tos_r() { return m_tos; }
	//void tos_w(const u32 data) { m_tos = data; }
	u32 meminit_r() { return m_meminit; }
	void meminit_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_meminit = data; }
	u32 transferdelay_r() { return m_transferdelay; }
	void transferdelay_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_transferdelay = data; }

	u32 mask_r() { return m_mask; }
	void mask_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_mask = data; }
	u32 tos_r() { return m_tos; }
	void tos_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_tos = data; }

	virtual void boot_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_boot = data; }
...
protected:
	...
	void control_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_control = data; }
...
protected:
	...
	virtual void boot_w(offs_t offset, u32 data, u32 mem_mask = 0x00ffffff) override;

	u32 cursor_palette_r(const offs_t offset);
	void cursor_palette_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff);

	u32 vpreequalise_r() { return m_vpreequalise; }
	void vpreequalise_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_vpreequalise = data; }
	u32 vpostequalise_r() { return m_vpostequalise; }
	void vpostequalise_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_vpostequalise = data; }
	u32 linestart_r() { return m_linestart; }
	void linestart_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_linestart = data; }
	u32 control_a_r() { return m_control_a; }
	void control_a_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff);
	u32 control_b_r() { return m_control_b; }
	void control_b_w(offs_t offset, u32 data, u32 mem_mask = 0xffffffff) { m_control_b = data; }
